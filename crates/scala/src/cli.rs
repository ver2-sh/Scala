...
impl From<RuntimeUpdateTrack> for scala_core::RuntimeUpdatePreference {
...
#[command(
    ...
    long_about = "Scala. Discover local model artifacts, manage independently versioned engine runtimes, and serve local text generation through the Scala gateway."
)]
pub struct Cli {
...
pub enum Command {
    ...
    Status,
    /// Load a user-created Model Profile through the running Scala instance
    Load {
        /// Model Profile ID from `scala model-profiles list`
    ...
    /// Unload one Model Profile from the running Scala instance
...
pub enum ModelsCommand {
    ...
    Search {
        ...
        #[arg(long)]
        format: Option<scala_core::ArtifactFormat>,
    },
...
pub enum AuthCommand {
    ...
    Status,
    /// List, create, or revoke Scala API keys
    Keys(AuthKeysArgs),
}
...
impl From<ProfileRole> for scala_core::ModelRole {
...
impl From<BenchmarksCommand> for scala_engine::benchmark::BenchmarkRequest {
