...
struct ResponsesReasoning {
    effort: Option<scala_engine::ReasoningEffort>,
    enabled: Option<bool>,
    budget: Option<i64>,
}
...
fn responses_reasoning(value: Option<&Value>) -> Result<ResponsesReasoning, OpenAiError> {
    ...
    if effort == Some(scala_engine::ReasoningEffort::None) && enabled == Some(true) {
        return Err(OpenAiError::invalid(
...
struct ResponseContext {
    ...
    reasoning_effort: Option<scala_engine::ReasoningEffort>,
